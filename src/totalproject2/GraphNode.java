 ...
 * {@code L}. L'etichetta non pu&ograve; essere null. Le classi {@code GraphEdge<L>} e
 ...
 * pi&ugrave; comuni: attribuzione e modifica di un colore, di una distanza, di un
 * puntatore a un nodo predecessore e di tempi di ingresso/uscita durante una
 * visita. L'etichetta &egrave; immutabile, le altre informazioni possono cambiare e
 * non definiscono l'identit&agrave; del nodo, che &egrave; data esclusivamente
 * dall'etichetta. In altre parole, due nodi sono uguali se e solo se hanno
 * etichetta uguale.
 * <p>
 * In molti algoritmi sui grafi i nodi vengono inseriti in una coda di priorit&agrave;.
 * Questa classe implementa l'interfaccia PriorityQueueElement utilizzando il
 * campo floatingPointDistance come priorit&agrave; e il campo integerDistance come
 * handle intero in una coda con priorit&agrave; realizzata con uno heap rappresentato
 * in un array.
 *
...
public class GraphNode<L> implements PriorityQueueElement {
     ...
     * @throws NullPointerException se l'etichetta &egrave; null.
     */
    ...
    /**
     * Restituisce il nodo del grafo che correntemente &egrave; assegnato come
     * predecessore di questo nodo. Ad esempio pu&ograve; essere usato da un algoritmo
