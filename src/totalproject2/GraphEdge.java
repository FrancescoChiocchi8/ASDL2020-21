 ...
 * rispettivamente.
 * <p>
 * Un arco pu&ograve; essere orientato o non orientato, tale informazione &egrave; immutabile
 * e disponibile tramite il metodo {@code isDirected()}. I due nodi collegati
 * dall'arco sono immutabili e non possono essere nulli.
 * <p>
 * All'arco pu&ograve; essere associato un peso tramite i metodi
 * {@code setWeight(double} e {@code getWeight()}. Il peso, se non specificato
 * nel costruttore, &egrave; inizializzato automaticamente a {@code Double.NaN}. In tal
 * caso l'arco &egrave; considerato non pesato fino a quando non gli viene assegnato un
 ...
 * dei nodi non conta, cio&egrave; un arco tra {@code n1} ed {@code n2} e un arco tra
...
public class GraphEdge<L> {
     ...
     *                 orientato)
     * @param directed true se l'arco &egrave; orientato, false altrimenti
     * @param weight   peso associato all'arco
     * @throws NullPointerException se almeno uno dei due nodi &egrave; nullo
     */
    ...
    /**
     * Determina se questo arco &egrave; attualmente pesato.
     *
    ...
    /**
     * Indica se questo arco &egrave; orientato o no.
     *
     * @return true se questo arco &egrave; orientato, false altrimenti.
     */
    ...
    /**
     * Restituisce il peso assegnato all'arco. Nel caso in cui il peso &egrave; uguale
     * a Double.Nan l'arco &egrave; da considerarsi attualmente non pesato.
     *
    ...
    /*
     * Basato sul flag che definisce se l'arco &egrave; orientato o no e sugli hashCode
