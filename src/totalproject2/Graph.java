 ...
 * archi.
 * <p>
 * Il grafo pu&ograve; essere orientato o non orientato, la sottoclasse che estende
 * questa classe astratta specifica questo aspetto. Tale informazione &egrave;
 * disponibile tramite il metodo {@code isDirected()}.
 * <p>
 * Le etichette dei nodi sono obbligatorie ed uniche, cio&egrave; un nodo non pu&ograve; avere
...
public abstract class Graph<L> {
    ...
    /**
     * Determina se questo grafo &egrave; vuoto, cio&egrave; senza nodi e senza archi.
     *
     * @return se questo grafo &egrave; vuoto, false altrimenti.
     */
    ...
    /**
     * Determina se questo grafo &egrave; orientato oppure no.
     *
     * @return true se questo grafo &egrave; orientato, false altrimenti.
     */
     ...
     * @return true se il nodo &egrave; stato aggiunto, false altrimenti cio&egrave; se il
     * nodo &egrave; gi&agrave; &egrave; presente
     * @throws NullPointerException se il nodo passato &egrave; null
     */
     ...
     * <p>
     * Questa operazione &egrave; opzionale.
     *
     * @param node il nodo da rimuovere
     * @return true se il nodo &egrave; stato rimosso, false se il nodo non era
     * presente
     * @throws NullPointerException          se il nodo passato &egrave; null
    ...
    /**
     * Determina se c'&egrave; un certo nodo in questo grafo.
     *
     ...
     * @throws NullPointerException se l'etichetta &egrave; nulla
     */
     ...
     * funzionalit&agrave; &egrave; tipicamente disponibile se il grafo &egrave; rappresentato con
     * una matrice di adiacenza. Tale indice pu&ograve; anche essere usato per
     ...
     * nodo con etichetta {@code label}. L'indice pu&ograve; cambiare se il
     * grafo viene modificato togliendo dei nodi
     * @throws NullPointerException          se l'etichetta passata &egrave; null
     * @throws IllegalArgumentException      se un nodo con l'etichetta
     *                                       {@code label} non esiste in
     *                                       questo grafo
     * @throws UnsupportedOperationException se questa operazione non &egrave;
     ...
     *                                       corrisponde a nessun nodo o &egrave;
     *                                       fuori dai limiti
     *                                       dell'intervallo
     ...
     * non orientato l'ordine dei due nodi &egrave; ininfluente, in caso di grafo
     ...
     * arco non esiste nel grafo. Se il grafo &egrave; orientato l'arco
     * ricercato e restituito &egrave; quello che ha sorgente in node 1 e
     * destinazione in node2. Se il grafo non &egrave; orientato allora l'arco
     * restituito pu&ograve; contenere node1 e node 2 in qualsiasi ordine
     * @throws NullPointerException     se almeno uno dei due nodi passati &egrave;
     *                                  null
     ...
     * specificati. In caso di grafo non orientato l'ordine dei due nodi &egrave;
     ...
     * grafo &egrave; orientato l'arco ricercato e restituito &egrave; quello che ha
     * sorgente nel nodo di indice i e destinazione nel nodo di indice
     * j. Se il grafo non &egrave; orientato allora l'arco restituito pu&ograve;
     ...
     *                                       nessun nodo o &egrave; fuori dai
     ...
     * grafo &egrave; orientato, i nodi restituiti sono solo quelli collegati da un un
     ...
     * nodo specificato
     * @throws UnsupportedOperationException se il grafo su cui il metodo &egrave;
     *                                       chiamato non &egrave; orientato
     * @throws IllegalArgumentException      se il nodo passato non esiste
     * @throws NullPointerException          se il nodo passato &egrave; nullo
     */
     ...
     * @return true se l'arco &egrave; stato inserito, false se un arco esattamente
     * uguale gi&agrave; esiste
     * @throws NullPointerException     se l'arco passato &egrave; nullo
     * @throws IllegalArgumentException se almeno uno dei due nodi
     *                                  specificati nell'arco non esiste
     * @throws IllegalArgumentException se l'arco &egrave; orientato e questo grafo
     *                                  non &egrave; orientato o viceversa
     */
     ...
     * @return true se l'arco &egrave; stato rimosso, false se l'arco non era presente
     * @throws IllegalArgumentException      se almeno uno dei due nodi
    ...
    /**
     * Cerca se c'&egrave; un certo arco in questo grafo.
     *
     * @param edge l'arco da cercare
     * @return true se in questo grafo c' &egrave; l'arco specificato, false altrimenti
     * @throws NullPointerException     se l'arco passato &egrave; nullo
     * @throws IllegalArgumentException se almeno uno dei due nodi
     *                                  specificati nell'arco non esiste
     */
    ...
    /**
     * Restituisce il grado di un nodo, cio&egrave; il numero di archi connessi al
     * nodo. Nel caso di grafo orientato &egrave; la somma del numero di archi in
